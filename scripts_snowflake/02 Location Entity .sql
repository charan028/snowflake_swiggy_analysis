...
-- select * from stage_sch.location_stm;
-- create
-- temp table common.location_tmp as
-- select
-- * from stage_sch.location_stm;
...
-- select * from stage_sch.location_stm;
-- create
-- or replace temp table common.location_tmp as
-- select
-- * from stage_sch.location_stm;

-- delete from stage_sch.location where locationid like '%junk%' ;

-- csv_stg/delta/location/delta-day03-invalid-delimiter.csv
-- csv_stg/delta/location/delta-day01-2rows-add.csv
-- csv_stg/delta/location/delta-day02-2rows-update.csv
-- csv_stg/delta/location/day-03-duplicate-data.csv